...
bool mtp_verifier(uint256 hashTarget, uint256 mtpMerkleRoot, unsigned int nNonce,const block_mtpProof blockWithMTPProof[140], mtp_Proof mtpProof, uint256 *yL);
